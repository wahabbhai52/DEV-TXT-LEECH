...
CREDIT = os.environ.get("CREDIT", "⌯ @RIYA40X | ×͜× |")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "8164616452"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "8164616452").split()]  # Default to owner ID
